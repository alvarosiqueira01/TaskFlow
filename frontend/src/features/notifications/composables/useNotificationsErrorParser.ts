...
import type { FieldError } from '../types/notification.types';
...
/**
 * NOTE: intentionally duplicated across features (users, settings,
 * notifications) — cross-feature imports are disallowed by the Frontend
 * Architecture Standard. Promote to shared/utils if a canonical copy is
 * ever added there.
 */
